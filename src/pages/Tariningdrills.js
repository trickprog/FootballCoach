...
import imgdrills from "../assets/imgdrills.png";
      ...
      <div className="flex-col w-full">
        ...
        <div className="flex mx-10">
          ...
          <div className="">
            ...
            <iframe
              className="lg:w-[650px] lg:h-[350px] 2xl:w-[887px] 2xl:h-[620.56px]"
              src="https://www.youtube.com/embed/Ny6CUYovjoQ"
            ></iframe>
            <div className="lg:w-[650px]  2xl:w-[887px] ">
              <h4 class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white  my-5 ">
                Outer Pass Tutorial
              </h4>
          ...
          <div className="lg:ml-10 2xl:ml-20">
            <div className="flex justify-between">
              ...
              <div className="flex items-center ">
                <a href="/traningdrill/uploaddrills" class="inline-flex items-center py-2 px-4  text-sm font-medium text-black bg-white rounded-md ">
                  Upload Drill
                </a>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2  gap-10">
              {dataobject.map((val, ind) => {
                ...
                return (
                  <div
                    key={ind}
                    class="lg:max-w-[250px] 2xl:max-w-xs rounded-lg"
                  >
                    <div className="relative">
                      <div
                        class={
                          change
                            ? "absolute bottom-0 right-0 inline-flex items-center py-1 px-5 m-2  text-xs font-medium text-black bg-blue-500 rounded-md "
                            : "absolute bottom-0 right-0 inline-flex items-center py-1 px-5 m-2  text-xs font-medium text-black bg-green-500 rounded-md "
                        }
                      >
                        Passing
                      </div>
