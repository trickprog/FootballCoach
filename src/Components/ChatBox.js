    ...
    <>
      <div className="">
        <div className="w-full my-5 ">
          ...
          <div className="flex items-center gap-2 pb-5 px-5 border-b border-grey-500">
            ...
            <div>
              <div className="flex items-center gap-5">
                ...
                <div class="inline-flex items-center py-1 px-10  text-sm font-medium text-white bg-green-500 rounded-md ">
                  Player
                </div>
              </div>
          ...
          {/* Chat Of The  */}
          <div className=" lg:h-[450px] 2xl:h-[700px] overflow-y-scroll">
            <div class="flex items-center py-4 mx-10">
              <div class="flex-grow h-px bg-gray-400"></div>

              <span class="flex-shrink text-2xl text-gray-500 px-4  font-light">
                Today
              </span>
